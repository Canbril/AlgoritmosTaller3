...
public class Strassen
{
    ...
    public static int[][] llenarMatriz(int[][] matriz, int rows, int columns){
    ...
    public static void main (String[] args)
    {
        ...
        int rows = 1024;int columns = 1024;
        int[][] A = new int[rows][columns];
        int[][] B = new int[rows][columns];
        A=llenarMatriz(A, rows, columns);
        B=llenarMatriz(B, rows, columns);
